...
export interface Subscriber {
  ...
  /**
   * Країна точки за ISO 3166-1 alpha-2 — заміряна зворотним геокодуванням.
   *
   * Без неї `oblastOf` мовчки приписував людині за кордоном найближчу
   * українську область: заміряно, що точка в Торонто дає «Закарпаття». Відсікти
   * це відстанню неможливо — Рені за 221 км від обласного центру, а Перемишль
   * за 91 (див. `geo-country.ts`).
   *
   * `undefined` — НЕ ЗНАЄМО (стара підписка або джерело мовчало), і це не те
   * саме, що «не Україна»: мовчки відібрати тривоги в людини вдома гірше, ніж
   * зайвий раз назвати область.
   */
  country?: string | null;
  /** Коли країну визначили — щоб зрідка перепитати, а не тримати вічно. */
  countryAt?: number | null;
  /**
