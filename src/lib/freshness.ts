...
export const FRESHNESS_THRESHOLDS = {
  ...
  /**
   * Вік СПОСТЕРЕЖЕННЯ — коли джерело востаннє бачило хоч одну ціль.
   *
   * Пороги вищі за `air` навмисно й заміряно. Джерело оновлює позначки
   * дискретно, кожну своїм темпом: у живому зрізі найсвіжіша ціль була 0,3 хв
   * тому, найстаріша — 7,9 хв, медіана близько 2 хв. Поріг нижчий за десять
   * хвилин оголошував би поломкою справну, але тиху ніч — а це найшвидший
   * спосіб навчити людей не вірити банеру.
   */
  airObserved: { aging: 12, stale: 25 },
} as const;
