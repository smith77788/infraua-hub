...
function Console() {
   ...
   * перемикач під тривогою. Запит вузький (радіус кілька кілометрів) і йде
   * навколо того, куди дивиться людина, а не по всій країні; відповідь
   * кешується на боці сервера, тож повторні перегляди району безкоштовні.
   */
